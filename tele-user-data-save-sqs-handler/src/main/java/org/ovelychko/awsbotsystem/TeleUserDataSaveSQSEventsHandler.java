...
public class TeleUserDataSaveSQSEventsHandler implements RequestHandler<SQSEvent, String> {
    ...
    public String handleRequest(SQSEvent event, Context context) {
        ...
        for (SQSMessage msg : event.getRecords()) {
            try {
                TelegramUserData data = gson.fromJson(msg.getBody(), TelegramUserData.class);
